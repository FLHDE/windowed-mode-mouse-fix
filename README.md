...
Fixes the mouse snapping and stuttering that occurs when playing games that utilize `dinput8.dll` in windowed mode (e.g. cursor warping to the center when it is near the edges of the window).
